  ...
  const featureBlocks = [
    {
      ...
      description: 'Быстро добавляйте книги в свою библиотеку, сканируя ISBN. Делитесь ими с друзьями и находите новые произведения для чтения.',
    ...
    },
    {
      ...
      description:
        'Просматривайте библиотеки друзей и выбирайте книги, доступные для чтения, не тратя деньги на покупку.',
    ...
    },
    {
      ...
      description:
        'Находите интересные книги на полках друзей и занимайте очередь. Договаривайтесь с владельцем или держателем, чтобы взять книгу.',
    ...
    },
    {
      ...
      description:
        'Приглашайте друзей, чтобы обмениваться книгами и следить за их библиотеками. Упрощайте процесс обмена.',
