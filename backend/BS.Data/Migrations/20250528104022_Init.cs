    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    IsProfileFilled = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    FirstName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    LastName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ContactUrl = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    IsProfilePhotoUploaded = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReceivedFriendRequestsId = table.Column<Guid>(type: "uuid", nullable: false),
                    SentFriendRequestsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFriends", x => new { x.FriendsId, x.UserEntityId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFriends_AspNetUsers_UserEntityId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "QueueItems",
                columns: new[] { "ItemId", "EnqueueTimeUtc" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFriends_UserEntityId",
                table: "UserFriends",
                column: "UserEntityId");
        }
